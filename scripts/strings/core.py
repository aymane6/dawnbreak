...
REPEAT = {
    "repeat.never": ["Once", "مرة واحدة", "Einmal", "Una vez", "Une fois", "एक बार", "Una volta", "1回のみ", "한 번", "Uma vez", "Один раз", "仅一次"],
    ...
    "repeat.weekdays": ["Weekdays", "أيام الأسبوع", "Wochentags", "Entre semana", "En semaine", "सप्ताह के दिन", "Nei giorni feriali", "平日", "주중", "Dias de semana", "По будням", "工作日"],
...
SOUNDS = family("sound.", "", {
    ...
    "buzzer": ["Buzzer", "جرس إنذار", "Summer", "Zumbador", "Buzzer", "बज़र", "Cicalino", "ブザー", "부저", "Zumbido", "Зуммер", "蜂鸣器"],
    "cicada": ["Cicada", "زيز", "Zikade", "Cigarra", "Cigale", "झींगुर", "Cicala", "セミ", "매미", "Cigarra", "Цикада", "蝉鸣"],
})
